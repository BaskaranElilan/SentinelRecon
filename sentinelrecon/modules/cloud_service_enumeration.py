...
from sentinelrecon.config.settings import DEFAULT_TIMEOUT, EXPORT_SETTINGS, RESULTS_DIR
...
UA = {"User-Agent":"sentinelreconCloudSvc/1.0"}

def banner():
    console.print("[cyan]" + "="*40)
    console.print("[cyan]   sentinelrecon – Cloud Service Enumeration")
    console.print("[cyan]" + "="*40)
