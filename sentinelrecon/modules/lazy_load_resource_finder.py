...
from sentinelrecon.utils.util import clean_domain_input, ensure_directory_exists, write_to_file
...
def banner():
    ...
    console.print("[cyan]     sentinelrecon – Lazy-Load Resource Finder")
    console.print(f"[{TEAL}]{'='*44}")
...
def run(target, threads, opts):
    ...
    session.headers.update({"User-Agent": "sentinelrecon-Lazy/1.0"})
    base = f"https://{dom}"
