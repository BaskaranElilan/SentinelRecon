...
from sentinelrecon.utils.util import ensure_url_format, clean_domain_input, validate_domain
...
def banner():
    ...
    console.print("[bold green]        sentinelrecon – Content Discovery         [/bold green]")
    console.print("[bold green]=============================================[/bold green]")
