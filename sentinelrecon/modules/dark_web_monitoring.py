...
def scylla(domain):
    try:
        r=requests.get(f"https://scylla.sh/search?q=email:*@{domain}&size=100",timeout=30,headers={'User-Agent':'sentinelrecon'})
...
def main(target):
    banner="[bold green]=============================================[/bold green]\n[bold green]       sentinelrecon – Dark‑Web Monitor            [/bold green]\n[bold green]=============================================[/bold green]"
