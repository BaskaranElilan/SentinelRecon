...
from sentinelrecon.utils.util import clean_domain_input, ensure_directory_exists, write_to_file, resolve_to_ip
...
def banner():
    ...
    console.print("[cyan]        sentinelrecon – Domain Information")
    console.print(f"[cyan]{bar}\n")
