...
def banner():
    ...
    =============================================
        sentinelrecon - Advanced Subdomain Takeover Detection
    =============================================
    """)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="sentinelrecon - Advanced Subdomain Takeover Detection Tool")
    parser.add_argument(
        'inputs',
        metavar='INPUT',
        type=str,
