...
from sentinelrecon.config.settings import DEFAULT_TIMEOUT
init(autoreset=True)
console = Console()
def banner():
    console.print("""
    =============================================
       sentinelrecon - Rogue Certificate Check
    =============================================
    """)
...
def fetch_ct(domain):
    ...
    out=[]
    try:
        r = requests.get(url, timeout=DEFAULT_TIMEOUT, headers={"User-Agent":"sentinelreconRogueCert/1.0"})
