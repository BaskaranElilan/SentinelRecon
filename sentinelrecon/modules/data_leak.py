...
def banner():
    ...
    =============================================
           sentinelrecon - Advanced Data Leak Checker
    =============================================
    """)
...
def check_email_breaches(email: str, session: requests.Session) -> tuple[str, list[dict] | None, str | None]:
    ...
    headers = {"User-Agent": "sentinelreconDataLeakChecker/1.0"}
    try:
...
def main():
    banner()
    p = argparse.ArgumentParser("sentinelrecon – Advanced Data Leak Checker")
