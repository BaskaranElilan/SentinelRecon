...
from sentinelrecon.modules.tls_cipher_suites import clean_domain_input
from sentinelrecon.utils.util import resolve_to_ip, ensure_directory_exists, write_to_file
...
def banner():
    ...
    console.print("[cyan]       sentinelrecon - NetBIOS Name Query")
    console.print(f"[#2EC4B6]{bar}\n")
