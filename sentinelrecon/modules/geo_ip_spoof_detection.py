...
from sentinelrecon.utils.util import resolve_to_ip, clean_domain_input, ensure_directory_exists, write_to_file
from sentinelrecon.config.settings import DEFAULT_TIMEOUT, RESULTS_DIR, EXPORT_SETTINGS, API_KEYS
...
def banner():
    ...
    console.print("[cyan]     sentinelrecon – Geo-IP Spoof Detection")
    console.print(f"[#2EC4B6]{bar}\n")

def query(name, tpl, ip, key, timeout):
    headers = {"User-Agent": "sentinelrecon"}
    if key:
