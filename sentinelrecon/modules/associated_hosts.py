...
from sentinelrecon.utils.util import resolve_to_ip, clean_domain_input, ensure_directory_exists, write_to_file, check_api_configured
from sentinelrecon.config.settings import DEFAULT_TIMEOUT, EXPORT_SETTINGS, RESULTS_DIR, API_KEYS
...
def banner():
    ...
    console.print(f"[{TEAL}] sentinelrecon – Associated Hosts")
    console.print(f"[{TEAL}]{border}")
