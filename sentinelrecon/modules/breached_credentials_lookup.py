...
from sentinelrecon.config.settings import DEFAULT_TIMEOUT, API_KEYS, EXPORT_SETTINGS, RESULTS_DIR
...
def banner():
    ...
    console.print("[cyan]   sentinelrecon – Breached Credentials Lookup")
    console.print("[cyan]" + "="*44)
