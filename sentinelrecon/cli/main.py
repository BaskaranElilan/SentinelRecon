...
from sentinelrecon.cli.commands import register_mixins
from sentinelrecon.cli.status_bar import print_status_bar
from sentinelrecon.cli.logo import logo
from sentinelrecon.cli.helpers import (
...
from sentinelrecon.utils.util import check_api_configured
from sentinelrecon.core.catalog_cache import (
    number_of_modules,
    VERSION,
    AUTHOR,
)
...
SentinelReconCLI = register_mixins(_BareCLI)

def main():
    SentinelReconCLI().cmdloop()
