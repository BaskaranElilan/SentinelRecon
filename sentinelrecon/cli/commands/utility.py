...
from sentinelrecon.cli.views.table_modules import display_table
from sentinelrecon.cli.logo import logo, TEAL
from sentinelrecon.core.catalog_cache import number_of_modules, VERSION, AUTHOR
...
class UtilityMixin:
    ...
    def do_info(self, _line) -> None:
        console.print()
        console.print(_header(" SentinelRecon Info "))
        console.print()
    ...
    def do_exit(self, _line) -> bool:
        console.print(Text("Exiting SentinelRecon. Goodbye!", style="bold green"))
        return True
