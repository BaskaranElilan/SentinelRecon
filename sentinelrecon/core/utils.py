...
def banner():
    console.rule("[bold cyan]SentinelRecon - Recon Toolkit", style="cyan")
...
_DISABLED_FILE = pathlib.Path.home() / ".sentinelrecon_disabled"
...
def check_updates(current_version: str, repo="BaskaranElilan/SentinelRecon"):
    try:
...
console = make_console(os.getenv("sentinelrecon_THEME", "default"))
