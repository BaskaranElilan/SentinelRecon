...
# Default target
help:
	@echo "SentinelRecon - Information Gathering & Reconnaissance Toolkit"
	@echo ""
	@echo "Available commands:"
	@echo "  install      - Install SentinelRecon and dependencies"
	@echo "  install-dev  - Install SentinelRecon with development dependencies"
	@echo "  test         - Run tests"
	...
	@echo "  docker-run   - Run SentinelRecon in Docker"
...
test-cov:
	pytest tests/ --cov=sentinelrecon --cov-report=html --cov-report=term-missing

# Code quality
lint:
	flake8 sentinelrecon/ tests/
	bandit -r sentinelrecon/
	mypy sentinelrecon/

format:
	black sentinelrecon/ tests/
	isort sentinelrecon/ tests/
...
# Security checks
security-check:
	bandit -r sentinelrecon/ -f json -o bandit-report.json
	safety check
